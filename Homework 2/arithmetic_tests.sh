...
echo Testing arithmetic operations (add, sub, mult, div, exp)
echo First test 15 + 15, field size = 17
./ecdsa.sh add 17 15 15 # field = 17, test 15 + 15
./ecdsa.sh sub 17 13 15 # test 13 - 15 
./ecdsa.sh mult 17 5 10
